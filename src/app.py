...
activities = {
    ...
    "Soccer Team": {
        "description": "Practice competitive soccer and play matches against other schools",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 6:00 PM",
        "max_participants": 22,
        "participants": ["alex@mergington.edu", "maria@mergington.edu"]
    },
    "Swimming Club": {
        "description": "Improve swim technique, endurance, and team relay skills",
    ...
    "Drama Club": {
        "description": "Rehearse scenes, develop acting skills, and perform for the school",
    ...
    "Debate Team": {
        "description": "Develop public speaking, research, and argument skills through debates",
